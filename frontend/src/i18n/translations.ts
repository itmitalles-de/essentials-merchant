const en = {
  ...
  "articles.name": "Name",
  "articles.unit": "Unit",
  "articles.salesPrice": "Sales price (net)",
  "articles.purchasePrice": "Purchase price (net)",
  "articles.minStock": "Minimum stock",
  "articles.stock": "Stock",
  "articles.confirmDelete": "Really delete this article?",
  "articles.back": "Back to articles",
  "articles.adjustStock": "Adjust stock",
  "articles.movementType": "Movement",
  "articles.movement.in": "Stock receipt",
  "articles.movement.out": "Stock issue",
  "articles.movement.adjustment": "Stocktake correction",
  "articles.quantity": "Quantity",
  "articles.note": "Note",
  "articles.saveMovement": "Save movement",
  "articles.movementHistory": "Movement history",
  "articles.colDate": "Date",
  "articles.colMovement": "Movement",
  "articles.colQuantity": "Quantity",
  "articles.colNote": "Note",
  "articles.noMovements": "No stock movements yet.",
  ...
  "orders.externalId": "External order ID",
  "orders.carrier": "Carrier",
  "orders.tracking": "Tracking number",
  "orders.item": "Article / item",
  "orders.quantity": "Quantity",
  "orders.create": "Create order",
  "orders.manual": "Manual",
  "orders.woocommerce": "WooCommerce",
  "orders.amazon": "Amazon",
  "orders.ebay": "eBay",
  "orders.noCarrier": "No carrier selected",
  "orders.colNumber": "Number",
  "orders.colCustomer": "Customer",
  "orders.colSource": "Channel",
  "orders.colCarrier": "Carrier",
  ...
  "orders.fulfill": "Confirm fulfillment",
  "orders.confirmFulfill": "Confirm fulfillment and book stock",
  "orders.fulfillHint": "Stock-linked order items are booked out exactly once when fulfillment is confirmed. This does not create a shipping label.",
  "orders.fulfillValidation": "Enter both carrier and tracking number, or leave both empty.",
  "orders.fulfillError": "Fulfillment could not be confirmed.",
  "orders.fulfilledAt": "Fulfilled at",
  ...
  "invoiceDetail.article": "Article",
  "invoiceDetail.customLineItem": "Custom line item",
...
const de: Record<keyof typeof en, string> = {
  ...
  "articles.cancel": "Abbrechen",
  "articles.sku": "Artikelnummer",
  "articles.name": "Bezeichnung",
  "articles.unit": "Einheit",
  "articles.salesPrice": "Verkaufspreis (netto)",
  "articles.purchasePrice": "Einkaufspreis (netto)",
  "articles.minStock": "Mindestbestand",
  "articles.stock": "Bestand",
  "articles.confirmDelete": "Diesen Artikel wirklich löschen?",
  "articles.back": "Zurück zu Artikeln",
  "articles.adjustStock": "Bestand buchen",
  "articles.movementType": "Bewegung",
  "articles.movement.in": "Wareneingang",
  "articles.movement.out": "Warenausgang",
  "articles.movement.adjustment": "Inventurkorrektur",
  "articles.quantity": "Menge",
  "articles.note": "Notiz",
  "articles.saveMovement": "Bewegung speichern",
  "articles.movementHistory": "Bewegungshistorie",
  "articles.colDate": "Datum",
  "articles.colMovement": "Bewegung",
  "articles.colQuantity": "Menge",
  "articles.colNote": "Notiz",
  "articles.noMovements": "Noch keine Lagerbewegungen.",
  ...
  "orders.externalId": "Externe Bestellnummer",
  "orders.carrier": "Dienstleister",
  "orders.tracking": "Sendungsnummer",
  "orders.item": "Artikel / Position",
  ...
  "orders.amazon": "Amazon",
  "orders.ebay": "eBay",
  "orders.noCarrier": "Kein Dienstleister",
  "orders.colNumber": "Nummer",
  "orders.colCustomer": "Kunde",
  "orders.colSource": "Kanal",
  "orders.colCarrier": "Dienstleister",
  "orders.colStatus": "Status",
  "orders.status": "Status",
  "orders.status.open": "offen",
  "orders.status.fulfilled": "erfüllt",
  "orders.status.cancelled": "storniert",
  "orders.back": "Zurück zu Aufträgen",
  "orders.detailTitle": "Auftrag",
  "orders.fulfill": "Versand bestätigen",
  "orders.confirmFulfill": "Versand bestätigen und Bestand buchen",
  "orders.fulfillHint": "Verknüpfte Artikel werden beim Bestätigen genau einmal ausgebucht. Es wird kein Versandlabel erzeugt.",
  "orders.fulfillValidation": "Dienstleister und Sendungsnummer zusammen eintragen – oder beides leer lassen.",
  "orders.fulfillError": "Der Versand konnte nicht bestätigt werden.",
  "orders.fulfilledAt": "Erfüllt am",
  ...
  "invoiceDetail.article": "Artikel",
  "invoiceDetail.customLineItem": "Freie Position",
